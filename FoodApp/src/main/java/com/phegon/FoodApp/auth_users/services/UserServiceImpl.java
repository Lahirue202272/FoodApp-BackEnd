...
public class UserServiceImpl implements UserService{
    ...
    public User getCurrentLoggedInUser() {
        ...
        //SecurityContextHolder:Stores security information of the current user,Who is currently logged in?
        //getContext():Security context (current request security info)
        //getAuthentication():Authentication object,This object contains:username (email),roles,login status
        //getName():The username of the logged-in user
    ...
    public Response<?> updateOwnAccount(UserDTO userDTO) {
        ...
        if (userDTO.getPassword() != null) {
            user.setPassword(passwordEncoder.encode(userDTO.getAddress()));
        }

...
//consumes = MediaType.MULTIPART_FORM_DATA_VALUE,Specifies the request type,This API accepts multipart/form-data
//ResponseEntity<Response<?>>:->return type
//@RequestPart:Extracts file from request